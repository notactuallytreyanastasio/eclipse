defmodule EclipseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EclipseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EclipseWeb.Gettext, "errors", msg, opts)
    end
  end
